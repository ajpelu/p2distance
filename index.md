...
much *new* information it contributes once the variables already
included are accounted for, using an iterative correction based on each
variable’s coefficient of determination (R²).
...
here, how strongly each partial indicator correlates with the overall P₂
distance:
...
![Barplot of correlations between each welfare variable and the P2
distance indicator](reference/figures/README-cor-plot-1.png)
...
The P₂ distance was proposed by the Spanish economist Jesús B. Pena
Trapero to measure social welfare (Pena, 1977), and has since been
applied to environmental quality indices, regional development, and
inequality studies (see
[`?p2distance`](https://ajpelu.github.io/p2distance/reference/p2distance.md)
for the full formula and additional references). See the
