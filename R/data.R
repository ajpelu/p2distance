...
#' the European Union during the 2002-2007 period. For each variable
#' (i.e. indicator), both its definition and the year it refers to are
#' given. The data come from EurLIFE, an interactive database on quality
#' of life in Europe (see Source).
#'
...
#'   life. Year: 2004.
#' - `people`: Trust in people. Mean value on a scale from 1 ("you can't
#'   be too careful in dealing with people") to 10 ("most people can be
#'   trusted"). Year: 2007.
...
#'   interests. Year: 2007.
#' - `education`: Satisfaction with education. Mean value on a scale from
#'   1 ("very dissatisfied") to 10 ("very satisfied"). Year: 2007.
...
#'   people aged 15 and over who live within walking distance or within
#'   20 minutes of the nearest primary school. Years: 1999, 2005.
...
#'   scale). Year: 2004.
#' - `stress`: Find work stressful. Share of people who "strongly agree"
#'   or "agree" that their work is too demanding and stressful. Year:
#'   2007.
...
#' - `job`: Job satisfaction. Percentage of employed people who are very
#'   or fairly satisfied with their job (four-item scale). Year: 2005.
#'
#' @source EurLIFE database. Interactive database on quality of life in
#'   Europe. European Foundation for the Improvement of Living and Working
#'   Conditions (Eurofound). Accessed 20 Feb 2012.
#'
#' @references
